...
func TestRelation(t *testing.T) {
	...
	// 	}
	// }
	// assert.True(t, containTestUserB, "Friend test user failed")
	...
	// 	}
	// }
	// assert.False(t, containTestUserB, "Cancle follow test user failed")
	...
	// 	}
	// }
	// assert.False(t, containTestUserA, "Cancle follow test user failed")
