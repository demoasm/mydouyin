...
(
    ...
    `avatar`   varchar(128) NULL DEFAULT NULL '' COMMENT 'Avatar',
    `background_image`   varchar(128) NULL DEFAULT NULL '' COMMENT 'background_image',
    `signature`   varchar(128) NULL DEFAULT NULL '' COMMENT 'signature',
    `total_favorited`   int unsigned Not NULL DEFAULT 0 '' COMMENT 'total_favorited',
